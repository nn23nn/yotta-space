		...
		<div class="col-xs-12">
			<form class="form-horizontal center" id="formView" action="/admin/category/save" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="col-xs-10 col-sm-10" placeholder="分类名称" id="name" name="name" datatype="s4-50" errormsg="分类至少4个字符，最多50个字符！" nullmsg="请输入分类名称！">
					</div>
				</div>
				<div class="form-group">
					<label for="name" class="col-sm-4 control-label no-padding-right">别名：</label>
					<div class="col-sm-8">
						<input type="text" class="col-xs-10 col-sm-10" placeholder="别名" id="alias" name="alias" datatype="s4-50" errormsg="分类别名至少4个字符，最多50个字符！" nullmsg="请输入分类别名！">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8 align-left" style="padding-top:8px">
						<input type="checkbox" class="ace ace-switch ace-switch-6" checked="true" name="status"/>
						<span class="lbl"></span>
					</div>
				</div>
