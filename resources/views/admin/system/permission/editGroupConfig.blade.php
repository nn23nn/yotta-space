				...
				<div class="pageheader">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="/admin/system/permission/editGroupConfig/{{ $permission->id }}">编辑权限分组</a>
                            </li>
						</ul>
					</div>
				</div>
									...
									<div class="col-md-6">
										<form class="form-horizontal" action="/admin/system/permission/saveGroupConfig" method="post">
	                                        ...
	                                        <div class="form-group">
	                                            ...
	                                            <div class="col-sm-9">
	                                            <input type="text" class="form-control" placeholder="权限名称" id="name" name="name" value="{{ $permission->name }}" datatype="s4-18" errormsg="权限名称至少4个字符，最多18个字符！" nullmsg="请输入权限名称！">
