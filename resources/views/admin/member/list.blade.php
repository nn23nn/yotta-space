				...
				<div class="pageheader">
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="/admin/system/user">会员列表</a>
                            </li>
						</ul>
					</div>
				</div>
								...
								<ul class="controls">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu pull-right with-arrow animated littleFadeInUp">
                                                <li>
                                                    <a href="/admin/member/create" role="button" tabindex="0">
									...
									<table data-filter="#filter" data-page-size="5" id="editable-usage" class="table table-custom">
	                                    ...
	                                    <tbody>
	                                    	...
	                                    	<tr>
	                                            ...
	                                            <td class="actions">
	                                            	<!-- <a role="button" tabindex="0" class="text-uppercase text-strong text-sm mr-10" href="/admin/member/edit/{{$user->id}}">更改</a> -->
	                                            	<a role="button" tabindex="0" class="text-danger text-uppercase text-strong text-sm" href="/admin/member/destroy/{{$user->id}}"  onclick="if(!confirm('确定要删除吗?')){return false;}">删除</a>
	                                            </td>
	                                        </tr>
	                                        @endforeach
	                                    </tbody>
